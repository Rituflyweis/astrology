  ...
  return (
    <header className="max-w-[1400px] mx-auto px-3 sm:px-4 pt-10">
      <h1 className="text-3xl md:text-4xl font-bold text-[#481299] mb-2">
        Connect with Wellness Consultants
      </h1>
      <p className="text-sm md:text-base text-[#0C4292] mb-6 max-w-2xl">
        Find the perfect consultant to guide your journey towards balance and
        well-being.
      </p>
